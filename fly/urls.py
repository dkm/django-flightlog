...
urlpatterns = patterns('',
    ...
    (r'^flight/new$', "fly.flightlog.views.create_flight"),
    (r'^flight/view/(?P<flight_id>\d+)/$', "fly.flightlog.views.flight_detail"),
    (r'^flight/edit/(?P<flight_id>\d+)/$', "fly.flightlog.views.flight_update"),
